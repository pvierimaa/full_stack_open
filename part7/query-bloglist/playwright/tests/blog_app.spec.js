...
describe('Blog app', () => {
  ...
  describe('When logged in', () => {
    ...
    test('a new blog can be created', async ({ page }) => {
      ...
      await expect(page.getByTestId('blog-summary')).toContainText(
        'Michael Chan'
      )
    })
    ...
    test('blogs are ordered according to likes, with the most liked blog first', async ({
      page,
    }) => {
      ...
      const blogTitles = []
      const blogSummaryElements = await page.locator(
